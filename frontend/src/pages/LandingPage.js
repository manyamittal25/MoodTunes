      ...
      <Box sx={styles.heroSection}>
        <Container maxWidth="md">
          ...
          <Typography variant="h6" sx={styles.heroSubtitle}>
            ...
            MoodTunes - music that understands you.
          </Typography>
        </Container>
      </Box>
      ...
      <Box sx={styles.informativeSection}>
        <Container>
          ...
          <Grid container spacing={4}>
            {whyChooseMoodTunes.map((item, index) => (
              <Grid item xs={12} md={4} key={index}>
...
const features = [
  ...
  },
  {
    ...
    description: "Access MoodTunes from any device, anytime, anywhere.",
  },
  {
...
const testimonials = [
  {
    text: "MoodTunes's recommendations are spot on! It really understands my moods.",
    author: "Ricky Nguyen",
  },
  {
  ...
  {
    text: "I've discovered so many great songs through MoodTunes!",
    author: "Katarina Chen",
  },
];

// Additional Section Data
const whyChooseMoodTunes = [
  {
    title: "Personalized Experience",
    description:
      "MoodTunes tailors music recommendations based on your unique emotional journey.",
  },
  {
  ...
  },
  {
    ...
    description:
      "MoodTunes integrates effortlessly with your favorite music streaming services.",
  },
];
