  ...
  return (
    <Box style={styles.container}>
      <Paper elevation={4} style={styles.policyContainer}>
        ...
        <Typography variant="body1" style={styles.text}>
          Welcome to MoodTunes! These terms and conditions outline the rules and
          regulations for the use of MoodTunes's services. By accessing and using
        ...
        <Typography variant="body1" style={styles.text}>
          By accessing or using MoodTunes, you agree to comply with and be bound
        ...
        <Typography variant="body1" style={styles.text}>
          When using MoodTunes, you agree not to engage in the following
        ...
        <ul style={styles.list}>
          ...
          <li>Engaging in unauthorized access to MoodTunes's systems or data.</li>
        ...
        <Typography variant="body1" style={styles.text}>
          ...
          text, graphics, logos, and software) provided by MoodTunes are owned by
        ...
        <Typography variant="body1" style={styles.text}>
          ...
          as part of your experience on MoodTunes. By submitting this content, you
        ...
        <Typography variant="body1" style={styles.text}>
          We may terminate or suspend your access to MoodTunes at our discretion,
        ...
        <Typography variant="body1" style={styles.text}>
          In no event shall MoodTunes, its directors, employees, or agents be
